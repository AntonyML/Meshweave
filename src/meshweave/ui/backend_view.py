...
class BackendView:
    ...
    def _build(self, parent):
        ...
        entry_kw = dict(fg_color="#ffffff", text_color=C["text"],
                        border_color=C["border"], placeholder_text_color=C["muted"])
        self.path_entry = ctk.CTkEntry(row, font=ctk.CTkFont(*FONT_MONO), **entry_kw)
